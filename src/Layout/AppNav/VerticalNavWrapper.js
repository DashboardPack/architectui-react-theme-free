...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav, MenuNav, AccountNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <h5 className="app-sidebar__heading">Menu</h5>
                <MetisMenu content={MenuNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
                <h5 className="app-sidebar__heading">Account Settings</h5>
                <MetisMenu content={AccountNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
