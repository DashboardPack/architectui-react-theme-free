...
export default class AnalyticsJob1 extends Component {
    constructor() {
        super();
            ...
            <Fragment>
                <ReactCSSTransitionGroup
                    ...
                    <div>
                        <PageTitle
                            heading="Basic Job"
                            subheading="This is an example Job created using build-in elements and components."
